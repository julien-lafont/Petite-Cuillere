...
| [`migrations.md`](./migrations.md)                       | **Migrations Supabase** : créer une migration, l'essayer, la faire appliquer à la production au push ; configuration à faire une fois.          | On **change le schéma** de la base.                                  |
